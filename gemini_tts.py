"""
gemini_tts.py — cosmos_paneli doğal seslendirme (Leda) (Gemini 2.5 TTS)
...
STIL = ("Narrate calmly, with awe and wonder, like a cosmos documentary — unhurried, clear, captivating: ")
