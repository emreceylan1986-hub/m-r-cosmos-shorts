...
NIS_ANAHTAR = [
    "black hole facts", "neutron star", "exoplanet discovery",
    "galaxy collision", "JWST image", "Hubble image",
    "saturn rings", "jupiter moons", "mars exploration",
    "nebula facts", "dark matter", "cosmic horror",
    "space facts", "universe scale", "supernova",
]
